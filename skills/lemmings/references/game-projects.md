...
Persistent validation clones are project lifetime, never assigned to writers, permit one Editor/BatchMode lease, retain Unity Library, and are never automatically cleaned or removed. Dirty state blocks only validation and needs manual resolution.
