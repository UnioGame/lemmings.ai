---
name: lemmings-claude-reviewer
description: Independently reviews a Lemmings candidate or plan against its brief, read-only, and returns a verdict. Use for: Independent candidate and plan review
