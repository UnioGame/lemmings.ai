---
name: lemmings-claude-worker
description: Implements one Lemmings brief inside its owned paths, runs its checks, commits, and reports. Use for: Everyday implementation, tests, and repairs
