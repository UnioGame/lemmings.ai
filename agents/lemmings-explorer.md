...
For a skill-only assignment, return the answer, evidence, and remaining uncertainty. For a runtime assignment, additionally obey the AgentInvocation v5 grant and return its compact AgentResult v5 envelope.
