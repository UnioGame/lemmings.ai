...
Implement one Ready task or one explicitly authorized Repair cycle. Return compact AgentResult v4 evidence and the candidate head, then stop. Do not orchestrate, delegate, repeat the assignment, start a second repair dispatch, or edit outside ownership. Treat model-authored usage as untrusted accounting data.
