...
| ORCH-008 | P2 | Accepted | Validator/status: dependencies, paths, models, drift and validation debt | ORCH-007 |
| ORCH-009 | P2 | Accepted | Worktree reconciliation and safe cleanup inspection | ORCH-008 |
| ORCH-010 | P2 | Accepted | Hybrid hooks and custom profiles | ORCH-009 |
| ORCH-011 | P1 | Accepted | AutoQA workspace pilot: repo-scoped plugin, adapter and docs gate | ORCH-010 |
| ORCH-012 | P3 | Accepted | Evals, hook fixtures and routing benchmark | ORCH-008 |

`Done` requires accepted review, integrated commit, phase validation, and recorded remaining validation debt.
The current `Accepted` items passed Sol High review but remain intentionally distinct from `Integrated`.
